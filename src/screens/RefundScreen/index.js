...
const RefundScreen = ({ navigation }) => (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
            ...
            <Text style={styles.title}>Refund and Cancellations</Text>
            <View style={styles.backBtn} />
        </View>
        <View style={styles.body}>
            <MaterialCommunityIcons name="restart" style={styles.icon} />
            <Text style={styles.heading}>Refund and Cancellations</Text>
